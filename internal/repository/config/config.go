...
var CustomConfigItems = []auconfigapi.ConfigItem{
	{
		...
		Default:     "",
		Description: "username for basic-auth admin access to this service",
	...
	},
	{
		...
		Default:     "",
		Description: "password for basic-auth admin access to this service",
		Validate:    auconfigenv.ObtainNotEmptyValidator(),
	},
	{
	...
	{
		Key:         config.KeyKeySetUrl,
		EnvName:     config.KeyKeySetUrl,
		Default:     "",
